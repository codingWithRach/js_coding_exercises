function capitalize(word) {
  ...
  // Format Document added a space inside the substring method
...
function generateInitials(firstName, lastName) {
  ...
  // Format Document added a space inside each substring method
...
function getSalePrice(originalPrice, reduction) {
  ...
  // Format Document added spaces around the minus and division signs
